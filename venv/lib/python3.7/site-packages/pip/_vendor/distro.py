...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): Controls whether the
          ...
          If the lsb_release command is not available in the program excution
        ...
        * ``include_name`` (bool): Controls whether uname command output is
          ...
          the program excution path the data source for the uname command will
          be empty.
        ...
        * :py:exc:`subprocess.CalledProcessError`: The lsb_release command had
          some issue (other than not being available in the program excution
          path).
